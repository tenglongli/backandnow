...
simfun <- function(trial,rt,maxdelay,si){
  ...
  out1 <- mcmc(outcome=d1$delay,days=d1$report,week=d1$week,weekend=d1$weekend,iter=21000,sigma=0.2,maxdelay=20,si=si,size=6)
  ...
  out2 <- mcmc(outcome=d2$delay,days=d2$report,week=d2$week,weekend=d2$weekend,iter=21000,sigma=0.2,maxdelay=20,si=si,size=6)
  ...
  out3 <- mcmc(outcome=d3$delay,days=d3$report,week=d3$week,weekend=d3$weekend,iter=21000,sigma=0.2,maxdelay=20,si=si,size=6)
  ...
  out4 <- mcmc(outcome=d4$delay,days=d4$report,week=d4$week,weekend=d4$weekend,iter=21000,sigma=0.2,maxdelay=20,si=si,size=6)
  ...
  result <- list(est1=est1,est2=est2,est3=est3,est4=est4,estr1=estr1,estr2=estr2,estr3=estr3,estr4=estr4,
                 epic=epic,epicr=epicr,repc=repc,repcr=repcr,minday=minday)
  return(result)
}
